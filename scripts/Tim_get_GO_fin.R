# Rscript1.R
# eg. run: 
# Rscript get_GO_fin.R annotations.txt interestinggenes.txt output_file
...
# Delete these lines if running from CLI
universeFile<- "../local_data/Ptrichocarpa_444_v3.1.annotation_info_gene_GO.txt"
